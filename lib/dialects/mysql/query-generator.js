    ...
    selectQuery: function(tableName, options) {
      ...
      if (options.include) {
        ...
        options.include.forEach(function(include) {
		  ...
		  if(include.association.useJunctionTable){
		  
			  var table = include.association.connectorDAO.tableName;		// Joining first half of many-to-many association
			  var as = include.association.connectorDAO.tableName;
			  var tableLeft = include.association.connectorDAO.tableName;
			  var attrLeft = include.association.identifier;
			  var tableRight = tableName;
			  var attrRight = 'id';
			  ...
			  var table = include.daoFactory.tableName;						// Joining second half of many-to-many association
			  var as = include.as;
			  var tableLeft = include.association.connectorDAO.tableName;
			  var attrLeft = Object.keys(include.association.connectorDAO.primaryKeys)[0];
